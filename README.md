...
* To start using it; "**[click use this template](https://github.com/Razaque/project-temp/generate)**" and create your new repository,
...
* After **[generating your new repo with this template](https://github.com/Razaque/project-template/generate)**, make sure to, right after you clone it, run the script `SETUP_TEMPLATE.sh`.
...
<p align="center">
  ...
  Or watch [this video](https://gifs.com/gif/Razaque-s-readme-md-MwO5E3) to see the whole README template.
</p>
...
For the proper maintenance of the CHANGELOG.md, we recommend this [VSCode extension](https://github.com/Razaque/Changelog-and-Markdown-snippets)
and the read and understanding of the [keep a changelog guide](https://keepachangelog.com/en/1.0.0/).
Please read and comment about it in this [dev.to post](https://dev.to/Razaque/the-ultimate-github-project-temp-1264).
We also recommend installing all the [used bots](https://github.com/Razaque/project-temp#-used-github-bots).
...
<a href="https://github.com/Razaque/project-temp/generate">
  <img alt="@Razaque/project-temp's brand logo without text" align="right" src="https://i.imgur.com/3qK1sie.png" width="18%" />
</a>
...
<a href="https://github.com/sponsors/Razaque">
  <img alt="project logo" src="https://img.shields.io/badge/Sponsor-Razaque/project temp-blue?logo=github-sponsors&style=for-the-badge&color=red">
</a>
...
[![GitHub's followers](https://img.shields.io/github/followers/Josee9988.svg?style=social)](https://github.com/Razaque)
[![GitHub stars](https://img.shields.io/github/stars/Razaque/project-temp.svg?style=social)](https://github.com/Razaque/project-temp/stargazers)
[![GitHub watchers](https://img.shields.io/github/watchers/Razaque/project-temp.svg?style=social)](https://github.com/Razaque/project-temp/watchers)
[![GitHub forks](https://img.shields.io/github/forks/Razaque/project-temp.svg?style=social)](https://github.com/Razaque/project-temp/network/members)

Enjoy! 😃

> ⚠️ Remember that this template should be reviewed and modified to fit your requirements.
> The script **SETUP_TEMPLATE.sh** should be executed right when you clone your new repository generated from [here](https://github.com/Razaque/project-temp/generate).
> There will be files that will need *manual revision* ⚠️

_Made with a lot of ❤️❤️ by **[@Razaque](https://github.com/Razaque)**_
